...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final TextView tvAttendance = findViewById(R.id.tvAttendanceButton);
        tvAttendance.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                com.google.firebase.auth.FirebaseUser fbUser2 = com.google.firebase.auth.FirebaseAuth.getInstance().getCurrentUser();
                String uid2 = fbUser2 != null ? fbUser2.getUid() : null;
                AttendanceManager.markTodayAttendance(uid2, new AttendanceManager.SimpleCallback() {
                    @Override
                    public void onDone() {
                        tvAttendance.setText("\u2713  Attendance Marked!");
                    }
                });
            }
        });
